      ...
      <main className="mt-16 md:mt-20 px-6 md:px-28">
        ...
        <div className="flex flex-col md:flex-row gap-x-40 py-10">
          ...
          <div className="flex flex-col gap-y-5">
            ...
            <p className="text-xl md:text-2xl text-[#9F9F9F] tracking-wide">RS.{product.price}</p>
            ...
            <div className="flex gap-x-5 items-center">
              <div className="flex items-center bg-slate-100 w-fit rounded-md">
                <button className="text-3xl px-4 py-2 transition-all duration-200 hover:bg-slate-200" >-</button>
                <p className=" px-4 py-2 ">{product.stockLevel}</p>
                <button className="text-xl px-4 py-2 transition-all duration-200 hover:bg-slate-200" >+</button>
              </div>
